"""
Trace Logger Module
Ghi trace của quá trình xử lý 50 cases.
"""
...
class TraceLogger:
    """Logger cho việc trace execution."""

    def __init__(self):
        self.traces: List[Dict[str, Any]] = []

    def log_start(self, case_id: str, claimed_order_id: str):
        """Log bắt đầu xử lý một case."""
        self.traces.append({
            "event": "start",
            "case_id": case_id,
    ...
    def get_case_traces(self, case_id: str) -> List[Dict[str, Any]]:
        """Lấy tất cả traces cho một case."""
...
def get_trace_logger() -> TraceLogger:
    """Get hoặc create global trace logger."""
...
def log_case_start(case_id: str, claimed_order_id: str):
    """Convenience function để log case start."""
...
def log_agent_action(case_id: str, agent_name: str, action: str, data: Optional[Dict] = None):
    """Convenience function để log agent action."""

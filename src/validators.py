"""
Validators Module
Validate output schema v├á evidence IDs.
"""
...
def validate_evidence_id(evidence_id: str) -> Tuple[bool, str]:
    """
    Validate mß╗Öt evidence ID.

    Args:
        evidence_id: Evidence ID cß║ºn validate
...
def validate_evidence_ids(evidence_ids: List[str]) -> Tuple[bool, List[str]]:
    """
    Validate danh s├ích evidence IDs.

    Args:
        evidence_ids: List c├íc evidence IDs
...
def verify_evidence_exists_in_csv(
    ...
    """
    Verify evidence ID c├│ tß╗ôn tß║íi trong CSV data.

    Args:
        evidence_id: Evidence ID cß║ºn verify
        data_cache: Dict cß╗ºa DataFrames
...
def validate_output_schema(output: Dict[str, Any]) -> Tuple[bool, List[str]]:
    """
    Validate to├án bß╗Ö output schema.

    Args:
        output: Output dict cß║ºn validate

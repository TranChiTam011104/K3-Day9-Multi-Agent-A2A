...
def check_late_delivery_seller(
    ...
    """
    Kiểm tra điều kiện: giao trễ do seller bàn giao muộn.

    Args:
        is_late_delivery: Giao có trễ không
        late_sellers: Danh sách seller bàn giao muộn
...
def check_late_delivery_logistics(
    ...
    """
    Kiểm tra điều kiện: giao trễ do logistics, không phải seller.

    Args:
        is_late_delivery: Giao có trễ không
        late_sellers: Danh sách seller bàn giao muộn
        on_time_sellers: Danh sách seller bàn giao đúng hạn
        freight_total: Tổng tiền freight
...
def check_unsupported_late_claim(
    ...
    """
    Kiểm tra điều kiện: khiếu nại giao trễ không được hỗ trợ.
...
def apply_policy(
    ...
    Args:
        ...
        on_time_sellers: Danh sách seller bàn giao đúng hạn
        payments_count: Số lượng payment rows
        is_reconciled: Payment có khớp không
        freight_total: Tổng tiền freight

    Returns:
        PolicyResult với kết quả policy
    """

...
def get_case_order_id(case: Dict[str, Any]) -> str:
    """
    Trích xuất order_id từ case input.
...
def count_output_files() -> int:
    """
    Đếm số file trong output directory.
...
def verify_all_outputs(expected_count: int = 50) -> Dict[str, Any]:
    """
    Verify tất cả outputs đã được tạo.

    Args:
        expected_count: Số lượng expected outputs

    Returns:
        Dict với thông tin verification
    """
